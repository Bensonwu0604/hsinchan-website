...
const translations = {
  zh: {
    ...
    esg_stat7_label: '創造企業價值', esg_stat7_sub: '七大自動化服務降本增效',
    esg_stat8_label: '循環經濟', esg_stat8_sub: '六大產品客製化延長設備壽命',
  ...
  ja: {
    ...
    esg_stat7_label: '企業価値の創造', esg_stat7_sub: '7つの自動化サービスでコスト削減と効率化',
    esg_stat8_label: '循環経済', esg_stat8_sub: '6製品ラインのカスタム対応で設備寿命を延伸',
  ...
  en: {
    ...
    esg_stat7_label: 'Creating Enterprise Value', esg_stat7_sub: 'Seven automation services cutting cost, boosting efficiency',
    esg_stat8_label: 'Circular Economy', esg_stat8_sub: 'Custom specs across six product lines extend equipment life',
