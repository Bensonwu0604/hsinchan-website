...
const translations = {
  zh: {
    ...
    about_banner_lead: '30年精密製造經驗，深根桃園，服務全台灣工業客戶。以技術立業，以品質興業，以服務創業。',
    about_our_title: '關於我們',
    about_desc_1: '欣晨工業有限公司成立於1996年，座落於桃園市大園工業區。歷經30年的積累，我們從早期的工業耗材供應商，逐步發展為涵蓋自動化設備設計、製造、整合及售後服務的全方位製造夥伴。',
    about_desc_2: '公司主要產品涵蓋碳化矽保護管、高濃度奈米氣泡流體模組、加熱器、熱電偶等高溫工業耗材，並持續拓展數位雙生規劃、機械手臂應用、視覺檢測等智能自動化服務領域。',
    ...
    tech_d4_desc: '人形機器人的關節傳動、末端執行器與感知系統需要兼顧輕量化與高精度的零件製造。欣晨憑藉30年精密加工經驗，提供鋁合金結構件、精密傳動套筒及耐磨陶瓷元件。',
    ...
    career_page_lead: '加入欣晨工業，與我們一同傳承30年精密製造工藝，共同迎接自動化與新材料時代的機遇與挑戰。',
  ...
  ja: {
    ...
    about_banner_lead: '30年の精密製造経験、桃園を拠点に台湾全土の産業顧客にサービスを提供。技術・品質・サービスを事業の礎に。',
    about_our_title: '私たちについて',
    about_desc_1: '欣晨工業有限公司は1996年に創業し、桃園市大園工業区に位置しています。30年の積み重ねにより、初期の産業用消耗品サプライヤーから、自動化設備の設計・製造・統合・アフターサービスを含む総合製造パートナーへと発展しました。',
    about_desc_2: '主な製品は炭化ケイ素保護管、高濃度ナノバブル流体モジュール、ヒーター、熱電対などの高温工業用消耗品です。また、デジタルツイン計画、ロボットアーム応用、画像検査などのインテリジェント自動化サービス分野にも継続的に拡大しています。',
    ...
    tech_d4_desc: 'ヒューマノイドロボットの関節駆動・エンドエフェクター・センシングシステムは軽量化と高精度を兼ね備えた部品製造を必要とします。欣晨は30年の精密加工経験を活かし、アルミ合金構造部品・精密駆動スリーブ・耐摩耗セラミック部品を提供します。',
    ...
    career_page_lead: '欣晨工業に加わり、30年の精密製造技術を受け継ぎ、自動化と新材料時代の機会と挑戦を共に迎えましょう。',
  ...
  en: {
    ...
    about_banner_lead: '30 years of precision manufacturing expertise, rooted in Taoyuan, serving industrial clients across Taiwan. Built on technology, quality, and service.',
    about_our_title: 'About Us',
    about_desc_1: 'Founded in 1996, Hsin-Chan Industrial Co., Ltd. is located in the Dayuan Industrial District, Taoyuan. Over the past 30 years, we have evolved from an industrial consumables supplier into a full-service manufacturing partner encompassing automation equipment design, manufacturing, integration, and after-sales support.',
    about_desc_2: 'Our core products include silicon carbide protection tubes, high-concentration nano-bubble fluid modules, heaters, and thermocouples — high-temperature industrial consumables. We continue expanding into intelligent automation services including digital twin planning, robotic arm applications, and machine vision inspection.',
