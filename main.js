...
const translations = {
  zh: {
    ...
    esg_stat5_label: '雙軸轉型', esg_stat5_sub: '數位化 × 淨零雙軸並進',
    esg_stat6_label: '產業耗能降低', esg_stat6_sub: '耐火材料窯爐隔熱等級',
  ...
  ja: {
    ...
    esg_stat5_label: 'ツイントランスフォーメーション', esg_stat5_sub: 'デジタル化 × カーボンニュートラルの両軸推進',
    esg_stat6_label: '産業エネルギー消費削減', esg_stat6_sub: '耐火材料の炉断熱グレード',
  ...
  en: {
    ...
    esg_stat5_label: 'Dual Transformation', esg_stat5_sub: 'Digital × Net-Zero, advancing together',
    esg_stat6_label: 'Reduced Industrial Energy Consumption', esg_stat6_sub: 'Refractory material furnace insulation grade',
