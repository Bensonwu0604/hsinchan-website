...
const translations = {
  zh: {
    ...
    nav_services: '服務項目', nav_tech: '新技術討論', nav_esg: 'ESG',
    ...
    pth_lead: '欣晨工業是台灣專業熱電偶廠商，提供全系列工業熱電偶，K、J、T、E、R、S、B 型，測溫範圍 -200°C ～ +1820°C，符合 IEC 584 國際標準。',
    ...
    pth_faq5_q: '台灣有推薦的熱電偶廠商嗎？',
    pth_faq5_a: '欣晨工業有限公司是台灣桃園專業熱電偶廠商，提供K、J、T、E、R、S、B型全系列工業熱電偶，符合IEC 584國際標準，並支援客製化保護管材質與尺寸，電話03-381-4497。',
    ...
    phe_lead: '欣晨工業是台灣專業加熱設備廠商，提供精密加熱元件，從射出成型到鋁鑄造，最高工作溫度 1200°C，支援全客製化規格。',
    ...
    phe_faq5_q: '台灣有推薦的加熱設備廠商嗎？',
    phe_faq5_a: '欣晨工業有限公司是台灣桃園專業加熱設備廠商，30年以上製造經驗，提供電熱管、陶瓷加熱器、射出成型機加熱圈等工業加熱器全系列產品，並支援客製化規格與現場技術諮詢，電話03-381-4497。',
    ...
    psic_lead: '欣晨工業是台灣專業碳化矽保護管廠商，採用高純度碳化矽（SiC），耐溫超過 1600°C，抗熱衝擊、抗氧化、抗腐蝕，適用半導體製程與鋁鑄造高溫環境。',
    ...
    psic_faq4_q: '台灣有推薦的碳化矽保護管廠商嗎？',
    psic_faq4_a: '欣晨工業有限公司是台灣桃園專業碳化矽保護管廠商，提供高純度SiC（純度>99%）保護管，耐溫超過1600°C，適用半導體擴散爐管與鋁液熔煉保護，支援客製化尺寸，電話03-381-4497。',
    ...
    pref_lead: '欣晨工業是台灣專業耐火材料廠商，提供耐火磚、耐火泥及定形耐火製品，耐溫達 1800°C，適用各類冶金爐、工業窯爐及高溫製程設備。',
    ...
    pref_faq4_q: '台灣有推薦的耐火材料廠商嗎？',
    pref_faq4_a: '欣晨工業有限公司是台灣桃園專業耐火材料廠商，提供耐火磚、耐火泥、澆注料等定形與不定形耐火製品，耐溫達1800°C，適用冶金爐、工業窯爐及高溫設備，電話03-381-4497。',
    ...
    pib_lead: '欣晨工業是台灣專業料管廠商，一體成型無接縫設計，消除傳統料管滲漏風險。雙金屬合金與氮化合金材質，高耐磨、高耐腐蝕。',
    ...
    pib_faq4_q: '台灣有推薦的料管廠商嗎？',
    pib_faq4_a: '欣晨工業有限公司是台灣桃園專業料管廠商，提供一體式料管，雙金屬合金與氮化合金材質，適用壓鑄機（宇部/東芝/芝浦）與射出成型機，並支援螺桿、料嘴、加熱圈完整配套，電話03-381-4497。',
    ...
    pgt_lead: '欣晨工業是台灣專業奈米氣泡設備廠商，氣泡尺寸 < 100nm，產生高濃度奈米氣泡流體，應用於半導體製程、生醫設備與液冷系統，達到節能、高密度、免化學添加的潔淨效果。',
    ...
    pgt_faq5_q: '台灣有推薦的奈米氣泡設備廠商嗎？',
    pgt_faq5_a: '欣晨工業有限公司是台灣桃園專業奈米氣泡設備廠商，提供高濃度奈米氣泡流體模組，氣泡尺寸小於100nm，應用於半導體製程用水、生醫設備清洗與資料中心液冷系統，電話03-381-4497。',
    ...
    srv_page_lead: '欣晨工業有限公司是台灣桃園自動化設備廠商，提供七大自動化服務，從數位規劃、機械手臂整合、視覺檢測，到設備智能化升級、奈米氣泡流體應用，一站式滿足您的製造需求。',
    ...
    srv_d2_desc: '欣晨工業是台灣機械手臂整合廠商，整合各大品牌工業機器人（FANUC、ABB、KUKA、Yaskawa等），提供搬運、焊接、組裝、塗膠等多元應用，搭配末端夾爪設計與路徑規劃，打造高效柔性生產線。',
    ...
    srv_d4_desc: '欣晨工業是台灣視覺檢測廠商，結合工業相機、高精度鏡頭與AI影像分析技術，實現產品外觀瑕疵偵測、尺寸量測、條碼辨識及位置引導等功能，取代人工目視，大幅提升檢測效率與一致性。',
    ...
    srv_d5_desc: '欣晨工業是台灣夾治具廠商，設計並製造高精度工裝夾具與治具，用於自動化組裝、加工、檢測等製程。精確的定位與夾持設計，確保每一件產品的加工位置一致性，提升產品良率。',
    ...
    srv_faq1_q: '欣晨工業提供哪些自動化服務？',
    srv_faq1_a: '七大服務：數位雙生自動化設計規劃、機械手臂應用、單機自動化設計製造、視覺檢測、夾治具設計製造、設備智能化、高濃度奈米氣泡流體產業應用，涵蓋從規劃到交機的一站式需求。',
    srv_faq2_q: '機械手臂整合支援哪些品牌？',
    srv_faq2_a: 'FANUC、ABB、KUKA、Yaskawa（安川）、Universal Robots（UR），並提供第七軸線性走行軸設計製造、協作機器人（Cobot）安全整合。',
    srv_faq3_q: '設備智能化服務需要更換整套設備嗎？',
    srv_faq3_a: '不需要。設備智能化服務為既有傳統設備加裝PLC、HMI、IoT模組，無需全面換新即可實現遠端監控、資料蒐集與預知保養，以最低投資提升產線數位化水準。',
    srv_faq4_q: '視覺檢測AOI可以偵測哪些瑕疵？',
    srv_faq4_a: '結合工業相機、高精度鏡頭與AI影像分析，可偵測外觀瑕疵（刮傷、污點、缺料）、進行高精度尺寸量測（±0.01mm）、QR Code/Barcode/OCR辨識，並可整合PLC自動排除不良品。',
    srv_faq5_q: '單機自動化設計製造的流程是什麼？',
    srv_faq5_a: '從需求分析、機構設計（SolidWorks / Solid Edge）、PLC / HMI 程式開發，到整機測試、現場安裝與人員培訓，提供一條龍客製化服務。',
    srv_faq6_q: '高濃度奈米氣泡流體產業應用適合哪些場域？',
    srv_faq6_a: '半導體製程用水、生醫設備清洗、資料中心液冷系統，以物理性奈米氣泡取代化學藥劑，達成節能、免化學添加的效果。',
    ...
    // ESG page
    esg_eyebrow_top: 'ESG / SUSTAINABILITY',
    esg_page_title: 'ESG 永續發展',
    esg_page_lead: '從產品到服務，欣晨工業以精密製造能力協助客戶落實環境、社會與治理目標——永續不是口號，而是每一項產品規格與服務流程的一部分。',
    esg_stat1_label: '化學藥劑添加', esg_stat1_sub: '奈米氣泡流體模組',
    esg_stat2_label: '最高降低非計畫停機', esg_stat2_sub: '數位雙生・設備智能化',
    esg_stat3_label: '最高降低營運成本', esg_stat3_sub: '預防性維護成本節省',
    esg_stat4_label: '年治理與品質實績',
    esg_stat5_label: 'AI × 永續', esg_stat5_sub: 'AOI瑕疵偵測 × 設備智能化，AI驅動的雙重減碳能力',
    esg_stat6_label: '碳足跡', esg_stat6_sub: '桃園單一基地服務六大市場，降低跨境運輸碳排',
    esg_stat7_label: '創造企業價值', esg_stat7_sub: '半導體・量子運算・人形機器人等前瞻應用領域',
    esg_stat8_label: '循環經濟', esg_stat8_sub: '免化學添加・設備延壽・降低報廢',
    esg_e_num: 'ESG · E', esg_e_tag: 'Environmental', esg_e_title: '環境永續',
    esg_e_desc: '欣晨工業將節能減碳理念落實於產品設計與服務流程，協助客戶降低製程能耗、化學品用量與物料浪費，從源頭減少環境負擔。',
    esg_e_p1: '高濃度奈米氣泡流體模組：物理性奈米氣泡取代化學藥劑，免化學添加即可達到清潔與滅菌輔助效果，降低化學品採購與廢液處理成本',
    esg_e_p2: '數位雙生與設備智能化服務：IoT即時監控延長既有設備使用壽命，減少非計畫停機最多30%，降低設備汰換頻率與資源消耗',
    esg_e_p3: '耐火材料與工業加熱器：提升窯爐與加熱系統的隔熱效率，降低能源損耗',
    esg_e_p4: '視覺檢測AOI：自動瑕疵偵測降低不良品流出率，減少材料報廢與重工浪費',
    esg_e_btn: '諮詢環保製程方案',
    esg_s_num: 'ESG · S', esg_s_tag: 'Social', esg_s_title: '社會共融',
    esg_s_desc: '從產線安全到跨國服務，欣晨工業透過自動化技術降低作業風險，並以在地製造、多語言服務支持供應鏈韌性與人才發展。',
    esg_s_p1: '機械手臂整合與夾治具設計：取代高風險、高重複性人工作業，降低職業傷害風險',
    esg_s_p2: '客製化服務承諾1-2個工作日回覆：支持中小企業客戶穩定生產排程',
    esg_s_p3: '繁體中文、日文、英文三語服務：協助日本與東南亞客戶跨境供應鏈溝通無障礙',
    esg_s_p4: '桃園在地製造與人才培育：支持在地就業，深耕台灣製造業聚落30年',
    esg_s_btn: '了解人力資源與職缺',
    esg_g_num: 'ESG · G', esg_g_tag: 'Governance', esg_g_title: '誠信治理',
    esg_g_desc: '以豐田生產方式（TPS）與稻盛和夫「敬天愛人」哲學為核心，欣晨工業將品質可追溯性與透明溝通落實於每一筆訂單。',
    esg_g_p1: '每批產品出廠前進行尺寸、耐溫、強度等多項性能檢測，並提供完整檢驗報告',
    esg_g_p2: '現地現物（Genchi Genbutsu）原則：工程師親赴客戶現場確認需求，避免規格誤判',
    esg_g_p3: '客製化規格文件化管理，配合客戶供應鏈稽核與追溯需求',
    esg_g_p4: 'Kaizen持續改善文化：透過標準化作業（SOP）與防呆（Poka-yoke）機構降低品質風險',
    esg_g_btn: '聯絡我們了解合作規範',
    esg_faq1_q: '欣晨工業的產品如何協助客戶達成ESG目標？',
    esg_faq1_a: '欣晨工業將ESG實踐落實於產品與服務設計：環境面提供免化學添加的高濃度奈米氣泡流體模組與節能設備智能化服務；社會面以機械手臂整合、夾治具設計等自動化技術降低作業風險，並提供多語言跨境服務；治理面以出廠品質檢驗與現地現物原則確保供應鏈透明可追溯。',
    esg_faq2_q: '高濃度奈米氣泡流體模組對環境有什麼幫助？',
    esg_faq2_a: '傳統清洗製程仰賴化學藥劑，欣晨工業的高濃度奈米氣泡流體模組以物理性微衝擊力取代化學藥劑達到清潔與滅菌輔助效果，大幅降低化學品採購與廢液處理成本，同時減少化學廢液對環境的衝擊。',
    esg_faq3_q: '數位雙生與設備智能化服務如何降低資源浪費？',
    esg_faq3_a: '透過IoT感測器即時監控設備狀態，預知保養可減少非計畫停機最多30%，並延長既有設備使用壽命，降低因設備汰舊換新產生的資源消耗，無需全面更換新設備即可提升產線數位化與能源使用效率。',
    esg_faq4_q: '欣晨工業如何確保供應鏈治理與品質可追溯性？',
    esg_faq4_a: '每批產品出廠前均進行尺寸、耐溫、強度等多項性能檢測，並提供完整檢驗報告。同時秉持「現地現物」原則，工程師親赴客戶現場確認實際需求與環境限制，確保規格文件與實際交付一致，滿足客戶供應鏈稽核需求。',
    esg_eyebrow_cta: 'PARTNER WITH US',
    esg_cta_title: '想了解欣晨工業如何協助貴公司的ESG報告？',
    esg_cta_desc: '無論是製程減碳、供應鏈治理或永續採購需求，歡迎與欣晨工業技術團隊聯繫，我們協助您找到合適的產品與服務方案。',
    esg_cta_btn: '立即聯繫',
  ...
  ja: {
    ...
    nav_services: 'サービス', nav_tech: '新技術', nav_esg: 'ESG', nav_careers: '採用情報',
    nav_contact: 'お問い合わせ',
    ...
    pth_lead: '欣晨工業は台湾の専門熱電対メーカーです。K、J、T、E、R、S、B型まで全シリーズの工業用熱電対を取り揃え、測温範囲は-200°C～+1820°C、IEC 584国際規格に準拠しています。',
    ...
    pth_faq5_q: '台湾でおすすめの熱電対メーカーはありますか？',
    pth_faq5_a: '欣晨工業有限公司は台湾桃園の専門熱電対メーカーです。K、J、T、E、R、S、B型まで全シリーズの工業用熱電対を提供し、IEC 584国際規格に準拠、保護管材質やサイズのカスタム対応も可能です。電話：03-381-4497。',
    ...
    phe_faq5_q: '台湾でおすすめの加熱設備メーカーはありますか？',
    phe_faq5_a: '欣晨工業有限公司は台湾桃園の専門加熱設備メーカーです。30年以上の製造経験を持ち、電熱管、セラミックヒーター、射出成形機用ヒーターバンドなど工業用ヒーターの全ラインナップを提供。カスタム仕様や現場技術相談にも対応しています。電話：03-381-4497。',
    ...
    psic_lead: '欣晨工業は台湾の専門SiC保護管メーカーです。高純度炭化ケイ素（SiC）製で、耐熱温度1600°C以上、優れた耐熱衝撃性・耐酸化性・耐腐食性を備え、半導体プロセスやアルミ鋳造の高温環境に適しています。',
    ...
    psic_faq4_q: '台湾でおすすめのSiC保護管メーカーはありますか？',
    psic_faq4_a: '欣晨工業有限公司は台湾桃園の専門SiC保護管メーカーです。高純度SiC（純度>99%）を採用し、耐熱温度1600°C以上、半導体拡散炉やアルミ溶湯保護に対応、サイズのカスタムにも対応しています。電話：03-381-4497。',
    ...
    pref_lead: '欣晨工業は台湾の専門耐火材料メーカーです。耐火レンガ、耐火キャスタブル、定形耐火製品を提供し、耐熱温度1800°Cに対応、各種冶金炉、工業窯炉、高温プロセス設備に適しています。',
    ...
    pref_faq4_q: '台湾でおすすめの耐火材料メーカーはありますか？',
    pref_faq4_a: '欣晨工業有限公司は台湾桃園の専門耐火材料メーカーです。耐火レンガ、耐火キャスタブルなど定形・不定形耐火製品を提供し、耐熱温度1800°Cに対応、冶金炉・工業窯炉・高温設備に適しています。電話：03-381-4497。',
    ...
    pib_lead: '欣晨工業は台湾の専門バレルメーカーです。一体成形によるシームレス設計で、従来のバレルにあった漏れのリスクを解消。バイメタル合金や窒化合金材質により、優れた耐摩耗性と耐腐食性を実現します。',
    ...
    pib_faq4_q: '台湾でおすすめのバレルメーカーはありますか？',
    pib_faq4_a: '欣晨工業有限公司は台湾桃園の専門バレルメーカーです。一体型バレルを提供し、バイメタル合金・窒化合金材質でダイカスト機（宇部/東芝/芝浦）や射出成形機に対応。スクリュー・ノズル・ヒーターバンドのフルセット供給にも対応しています。電話：03-381-4497。',
    ...
    pgt_lead: '欣晨工業は台湾の専門ナノバブル設備メーカーです。気泡サイズ100nm未満の高濃度ナノバブル流体を生成し、半導体プロセス、医療機器、液冷システムに応用。省エネ・高密度・薬剤不使用のクリーンな効果を実現します。',
    ...
    pgt_faq5_q: '台湾でおすすめのナノバブル設備メーカーはありますか？',
    pgt_faq5_a: '欣晨工業有限公司は台湾桃園の専門ナノバブル設備メーカーです。気泡サイズ100nm未満の高濃度ナノバブル流体モジュールを提供し、半導体プロセス用水、医療機器洗浄、データセンター液冷システムに対応しています。電話：03-381-4497。',
    ...
    srv_page_lead: '欣晨工業有限公司は台湾桃園の自動化設備メーカーです。7つの自動化サービスを提供し、デジタル計画からロボットアーム統合・画像検査・設備インテリジェント化・ナノバブル流体応用まで、製造ニーズをワンストップで満たします。',
    ...
    srv_d2_desc: '欣晨工業は台湾のロボットアーム統合メーカーです。主要ブランドの産業用ロボット（FANUC・ABB・KUKA・Yaskawa等）を統合し、搬送・溶接・組立・塗布など多様な用途に対応。エンドエフェクター設計と経路計画で高効率フレキシブル生産ラインを構築します。',
    ...
    srv_d4_desc: '欣晨工業は台湾の画像検査（AOI）メーカーです。産業用カメラ・高精度レンズ・AI画像解析を組み合わせ、製品外観の欠陥検出・寸法測定・バーコード識別・位置誘導を実現。目視検査に代わり、検査効率と一貫性を大幅に向上させます。',
    ...
    srv_d5_desc: '欣晨工業は台湾の治具メーカーです。自動化組立・加工・検査プロセス向けの高精度工作治具・固定具を設計・製造。精確な位置決めとクランプ設計により、すべての製品の加工位置の一貫性を確保し、良品率を向上させます。',
    ...
    srv_faq1_q: '欣晨工業はどのような自動化サービスを提供していますか？',
    srv_faq1_a: '7つのサービス：デジタルツイン自動化設計、ロボットアーム応用、単機自動化設計製造、画像検査、治具設計製造、設備インテリジェント化、高濃度ナノバブル流体産業応用。計画から納品までワンストップで対応します。',
    srv_faq2_q: 'ロボットアーム統合はどのブランドに対応していますか？',
    srv_faq2_a: 'FANUC、ABB、KUKA、Yaskawa（安川電機）、Universal Robots（UR）に対応。第七軸リニアトラックの設計製造、協働ロボット（Cobot）の安全統合も提供します。',
    srv_faq3_q: '設備インテリジェント化サービスは設備一式を交換する必要がありますか？',
    srv_faq3_a: '不要です。既存の従来型設備にPLC・HMI・IoTモジュールを追加することで、全面更新なしに遠隔監視・データ収集・予知保全を実現し、最小限の投資で生産ラインのデジタル化を向上させます。',
    srv_faq4_q: '画像検査（AOI）はどのような欠陥を検出できますか？',
    srv_faq4_a: '産業用カメラ・高精度レンズ・AI画像解析を組み合わせ、外観欠陥（傷、汚れ、欠品）の検出、高精度寸法測定（±0.01mm）、QRコード/バーコード/OCR認識が可能で、PLCと連動した不良品の自動排除にも対応します。',
    srv_faq5_q: '単機自動化設計製造の流れを教えてください。',
    srv_faq5_a: '要件分析、機構設計（SolidWorks / Solid Edge）、PLC / HMIプログラム開発から、実機テスト、現場設置、人員トレーニングまで、一貫したカスタムサービスを提供します。',
    srv_faq6_q: '高濃度ナノバブル流体産業応用はどのような分野に適していますか？',
    srv_faq6_a: '半導体プロセス用水、医療機器洗浄、データセンター液冷システムに適用。物理的なナノバブルで化学薬品を代替し、省エネかつ薬品不使用の効果を実現します。',
    ...
    // ESG page
    esg_eyebrow_top: 'ESG / SUSTAINABILITY',
    esg_page_title: 'ESG 持続可能な発展',
    esg_page_lead: '製品からサービスまで、欣晨工業は精密製造能力でお客様の環境・社会・ガバナンス目標の実現を支援します。サステナビリティは掛け声ではなく、すべての製品仕様とサービスプロセスの一部です。',
    esg_stat1_label: '化学薬品添加', esg_stat1_sub: 'ナノバブル流体モジュール',
    esg_stat2_label: '計画外停止を最大削減', esg_stat2_sub: 'デジタルツイン・設備インテリジェント化',
    esg_stat3_label: '運営コスト最大削減', esg_stat3_sub: '予防保全によるコスト削減',
    esg_stat4_label: '年のガバナンスと品質実績',
    esg_stat5_label: 'AI × サステナビリティ', esg_stat5_sub: 'AOI外観検査 × 設備インテリジェント化、AI駆動の二重脱炭素能力',
    esg_stat6_label: 'カーボンフットプリント', esg_stat6_sub: '桃園単一拠点から6つの市場へ供給し、越境輸送による排出を削減',
    esg_stat7_label: '企業価値の創造', esg_stat7_sub: '半導体・量子コンピューティング・ヒューマノイドロボット等の先端応用分野',
    esg_stat8_label: '循環経済', esg_stat8_sub: '薬品不使用・設備長寿命化・廃棄削減',
    esg_e_num: 'ESG · E', esg_e_tag: 'Environmental', esg_e_title: '環境の持続可能性',
    esg_e_desc: '欣晨工業は省エネ・脱炭素の理念を製品設計とサービスプロセスに落とし込み、お客様のプロセスエネルギー消費、化学薬品使用量、材料廃棄の削減を支援します。',
    esg_e_p1: '高濃度ナノバブル流体モジュール：物理的なナノバブルで化学薬品を代替し、薬品不使用で洗浄・滅菌補助効果を実現、薬品調達と廃液処理コストを削減',
    esg_e_p2: 'デジタルツイン・設備インテリジェント化サービス：IoTリアルタイム監視で既存設備の寿命を延ばし、計画外停止を最大30%削減、設備更新頻度と資源消費を削減',
    esg_e_p3: '耐火材料・工業用ヒーター：炉や加熱システムの断熱効率を向上させ、エネルギー損失を削減',
    esg_e_p4: '画像検査（AOI）：自動欠陥検出により不良品流出率を低減し、材料廃棄と手直しの無駄を削減',
    esg_e_btn: '環境配慮型プロセスのご相談',
    esg_s_num: 'ESG · S', esg_s_tag: 'Social', esg_s_title: '社会的包摂',
    esg_s_desc: '生産ラインの安全性から国際サービスまで、欣晨工業は自動化技術で作業リスクを低減し、現地生産・多言語サービスでサプライチェーンの強靭性と人材育成を支援します。',
    esg_s_p1: 'ロボットアーム統合・治具設計：リスクの高い反復作業を代替し、労働災害リスクを低減',
    esg_s_p2: '1～2営業日以内の対応をお約束するカスタムサービス：中小企業のお客様の安定した生産スケジュールを支援',
    esg_s_p3: '繁体字中国語・日本語・英語の三言語サービス：日本・東南アジアのお客様との国境を越えたサプライチェーンコミュニケーションを支援',
    esg_s_p4: '桃園での現地生産と人材育成：地域雇用を支援し、台湾の製造業クラスターに30年間根を張ってきました',
    esg_s_btn: '採用情報を見る',
    esg_g_num: 'ESG · G', esg_g_tag: 'Governance', esg_g_title: '誠実なガバナンス',
    esg_g_desc: 'トヨタ生産方式（TPS）と稲盛和夫の「敬天愛人」の哲学を核に、欣晨工業は品質のトレーサビリティと透明なコミュニケーションをすべての注文に落とし込んでいます。',
    esg_g_p1: '出荷前にすべてのロットで寸法・耐熱性・強度など複数の性能試験を実施し、完全な検査報告書を提供',
    esg_g_p2: '現地現物の原則：エンジニアが実際にお客様の現場に赴き要件を確認し、仕様の誤解を防止',
    esg_g_p3: 'カスタム仕様の文書化管理により、お客様のサプライチェーン監査・トレーサビリティ要件に対応',
    esg_g_p4: '改善（Kaizen）文化：標準作業手順（SOP）とポカヨケ機構により品質リスクを低減',
    esg_g_btn: 'お問い合わせ・取引条件について',
    esg_faq1_q: '欣晨工業の製品はお客様のESG目標達成にどう貢献しますか？',
    esg_faq1_a: '欣晨工業はESGの実践を製品・サービス設計に落とし込んでいます。環境面では薬品不使用の高濃度ナノバブル流体モジュールと省エネ設備インテリジェント化サービスを提供。社会面ではロボットアーム統合や治具設計などの自動化技術で作業リスクを低減し、多言語での国境を越えたサービスを提供。ガバナンス面では出荷前品質検査と現地現物の原則によりサプライチェーンの透明性とトレーサビリティを確保しています。',
    esg_faq2_q: '高濃度ナノバブル流体モジュールは環境にどのようなメリットがありますか？',
    esg_faq2_a: '従来の洗浄プロセスは化学薬品に依存していますが、欣晨工業の高濃度ナノバブル流体モジュールは物理的な微衝撃力で化学薬品を代替し、洗浄・滅菌補助効果を実現します。薬品の調達と廃液処理コストを大幅に削減すると同時に、化学廃液による環境への影響を軽減します。',
    esg_faq3_q: 'デジタルツインと設備インテリジェント化サービスはどのように資源の無駄を削減しますか？',
    esg_faq3_a: 'IoTセンサーで設備状態をリアルタイム監視し、予知保全により計画外停止を最大30%削減。既存設備の使用寿命を延ばすことで、設備更新による資源消費を削減します。全面的な設備更新なしに、生産ラインのデジタル化とエネルギー使用効率を向上させることができます。',
    esg_faq4_q: '欣晨工業はどのようにサプライチェーンガバナンスと品質のトレーサビリティを確保していますか？',
    esg_faq4_a: '出荷前にすべてのロットで寸法・耐熱性・強度など複数の性能試験を実施し、完全な検査報告書を提供しています。また「現地現物」の原則を貫き、エンジニアが実際にお客様の現場に赴いて実際の要件と環境制約を確認することで、仕様書と実際の納品内容の一致を確保し、お客様のサプライチェーン監査要件を満たしています。',
    esg_eyebrow_cta: 'PARTNER WITH US',
    esg_cta_title: '欣晨工業が貴社のESGレポートにどう貢献できるかご興味はありますか？',
    esg_cta_desc: 'プロセスの脱炭素化、サプライチェーンガバナンス、サステナブル調達など、どのようなご要望でも欣晨工業の技術チームまでお気軽にお問い合わせください。最適な製品・サービスソリューションをご提案いたします。',
    esg_cta_btn: '今すぐお問い合わせ',
  ...
  en: {
    ...
    nav_services: 'Services', nav_tech: 'Technology', nav_esg: 'ESG', nav_careers: 'Careers',
    nav_contact: 'Contact',
    ...
    pth_lead: 'Hsin-Chan Industrial is a professional thermocouple manufacturer in Taiwan, offering a full range of industrial thermocouples — Types K, J, T, E, R, S, and B — covering -200°C to +1820°C and compliant with the IEC 584 international standard.',
    ...
    pth_faq5_q: 'Is there a recommended thermocouple manufacturer in Taiwan?',
    pth_faq5_a: 'Hsin-Chan Industrial Co., Ltd. is a professional thermocouple manufacturer based in Taoyuan, Taiwan, offering a full range of Type K, J, T, E, R, S, and B industrial thermocouples compliant with IEC 584, with custom protection-tube materials and sizing available. Call +886-3-381-4497.',
    ...
    phe_faq5_q: 'Is there a recommended industrial heating equipment manufacturer in Taiwan?',
    phe_faq5_a: 'Hsin-Chan Industrial Co., Ltd. is a professional heating equipment manufacturer based in Taoyuan, Taiwan, with over 30 years of manufacturing experience. We provide a full range of industrial heaters including tubular heaters, ceramic heaters, and heater bands for injection molding machines, with support for custom specifications and on-site technical consultation. Call +886-3-381-4497.',
    ...
    psic_lead: 'Hsin-Chan Industrial is a professional SiC protection tube manufacturer in Taiwan. Made from high-purity silicon carbide (SiC), rated above 1600°C with excellent thermal shock resistance, oxidation resistance, and corrosion resistance — ideal for semiconductor processes and aluminum casting environments.',
    ...
    psic_faq4_q: 'Is there a recommended SiC protection tube manufacturer in Taiwan?',
    psic_faq4_a: 'Hsin-Chan Industrial Co., Ltd. is a professional SiC protection tube manufacturer based in Taoyuan, Taiwan, offering high-purity SiC (>99% purity) tubes rated above 1600°C for semiconductor diffusion furnaces and molten aluminum protection, with custom sizing available. Call +886-3-381-4497.',
    ...
    pref_lead: 'Hsin-Chan Industrial is a professional refractory materials manufacturer in Taiwan, offering refractory bricks, refractory mortar, and shaped refractory products rated up to 1800°C — suited to a wide range of metallurgical furnaces, industrial kilns, and high-temperature process equipment.',
    ...
    pref_faq4_q: 'Is there a recommended refractory materials manufacturer in Taiwan?',
    pref_faq4_a: 'Hsin-Chan Industrial Co., Ltd. is a professional refractory materials manufacturer based in Taoyuan, Taiwan, offering refractory bricks, mortar, and both shaped and unshaped refractory products rated up to 1800°C for metallurgical furnaces, industrial kilns, and high-temperature equipment. Call +886-3-381-4497.',
    ...
    pib_lead: 'Hsin-Chan Industrial is a professional barrel manufacturer in Taiwan, offering a seamless, single-piece design that eliminates the leakage risks of conventional barrels. Made from bimetallic alloy or nitrided alloy for outstanding wear and corrosion resistance.',
    ...
    pib_faq4_q: 'Is there a recommended barrel manufacturer in Taiwan?',
    pib_faq4_a: 'Hsin-Chan Industrial Co., Ltd. is a professional barrel manufacturer based in Taoyuan, Taiwan, offering integrated barrels in bimetallic alloy and nitrided alloy for die-casting machines (UBE/Toshiba/Shibaura) and injection molding machines, with full sets of screws, nozzles, and heater bands available. Call +886-3-381-4497.',
    ...
    pgt_lead: 'Hsin-Chan Industrial is a professional nano-bubble equipment manufacturer in Taiwan, generating high-concentration nano-bubble fluid with bubble sizes under 100nm, for use in semiconductor processes, medical devices, and liquid cooling systems — delivering energy savings, high density, and chemical-free cleaning.',
    ...
    pgt_faq5_q: 'Is there a recommended nano-bubble equipment manufacturer in Taiwan?',
    pgt_faq5_a: 'Hsin-Chan Industrial Co., Ltd. is a professional nano-bubble equipment manufacturer based in Taoyuan, Taiwan, offering high-concentration nano-bubble fluid modules with bubble sizes under 100nm for semiconductor process water, biomedical equipment cleaning, and data center liquid cooling. Call +886-3-381-4497.',
    ...
    srv_page_lead: 'Hsin-Chan Industrial Co., Ltd. is an automation equipment manufacturer based in Taoyuan, Taiwan, offering seven automation services covering digital planning, robotic arm integration, machine vision inspection, equipment intelligence upgrades, and nano-bubble fluid applications — one-stop manufacturing solutions.',
    ...
    srv_d2_desc: 'Hsin-Chan Industrial is a robotic arm integrator in Taiwan, integrating major brand industrial robots (FANUC, ABB, KUKA, Yaskawa, etc.) for handling, welding, assembly, and dispensing applications, combined with end-effector design and path planning to build efficient, flexible production lines.',
    ...
    srv_d4_desc: 'Hsin-Chan Industrial is a machine vision (AOI) provider in Taiwan, combining industrial cameras, high-precision lenses, and AI image analysis to achieve product appearance defect detection, dimensional measurement, barcode recognition, and position guidance — replacing manual inspection.',
    ...
    srv_d5_desc: 'Hsin-Chan Industrial is a fixture and jig manufacturer in Taiwan, designing and manufacturing high-precision fixtures and jigs for automated assembly, machining, and inspection processes. Precise positioning and clamping ensures consistent machining positions for every product, improving yield rates.',
    ...
    srv_faq1_q: 'What automation services does Hsin-Chan Industrial provide?',
    srv_faq1_a: 'Seven services: Digital Twin automation planning, robotic arm applications, custom automation design and build, machine vision inspection, fixture and jig design, equipment intelligence upgrades, and high-concentration nano-bubble fluid industrial applications — a one-stop solution from planning to handover.',
    srv_faq2_q: 'Which robotic arm brands does the robot integration service support?',
    srv_faq2_a: 'FANUC, ABB, KUKA, Yaskawa, and Universal Robots (UR), plus 7th-axis linear track design and manufacturing and collaborative robot (Cobot) safety integration.',
    srv_faq3_q: 'Does the equipment intelligence upgrade service require replacing the entire machine?',
    srv_faq3_a: 'No. The service retrofits existing traditional equipment with PLC, HMI, and IoT modules, enabling remote monitoring, data collection, and predictive maintenance without a full equipment overhaul — upgrading digitalization with minimal investment.',
    srv_faq4_q: 'What defects can machine vision (AOI) inspection detect?',
    srv_faq4_a: 'Combining industrial cameras, high-precision lenses, and AI image analysis, it detects surface defects (scratches, stains, missing material), performs high-precision dimensional measurement (±0.01mm), and handles QR code/barcode/OCR recognition, with PLC integration for automatic rejection of defective parts.',
    srv_faq5_q: 'What is the process for custom automation design and build?',
    srv_faq5_a: 'From requirements analysis, mechanical design (SolidWorks / Solid Edge), and PLC/HMI programming, to machine testing, on-site installation, and staff training — a complete end-to-end custom service.',
    srv_faq6_q: 'What applications suit the high-concentration nano-bubble fluid industrial service?',
    srv_faq6_a: 'Semiconductor process water, biomedical equipment cleaning, and data center liquid cooling systems. Physical nano-bubbles replace chemical additives, delivering energy savings and chemical-free operation.',
    ...
    // ESG page
    esg_eyebrow_top: 'ESG / SUSTAINABILITY',
    esg_page_title: 'ESG Sustainability',
    esg_page_lead: 'From products to services, Hsin-Chan Industrial applies its precision manufacturing capabilities to help customers meet Environmental, Social, and Governance goals — sustainability isn\'t a slogan, it\'s built into every product spec and service process.',
    esg_stat1_label: 'Chemical Additives', esg_stat1_sub: 'Nano-Bubble Fluid Module',
    esg_stat2_label: 'Max Reduction in Unplanned Downtime', esg_stat2_sub: 'Digital Twin / Smart Upgrade',
    esg_stat3_label: 'Max Reduction in Operating Costs', esg_stat3_sub: 'Preventive maintenance cost savings',
    esg_stat4_label: 'Years of Governance & Quality Track Record',
    esg_stat5_label: 'AI × Sustainability', esg_stat5_sub: 'AOI defect detection × equipment intelligence — AI-driven dual decarbonization capability',
    esg_stat6_label: 'Carbon Footprint', esg_stat6_sub: 'A single Taoyuan facility serves six markets, cutting cross-border shipping emissions',
    esg_stat7_label: 'Creating Enterprise Value', esg_stat7_sub: 'Semiconductor, quantum computing, humanoid robotics, and other frontier applications',
    esg_stat8_label: 'Circular Economy', esg_stat8_sub: 'Chemical-free processes, extended equipment life, reduced scrap',
    esg_e_num: 'ESG · E', esg_e_tag: 'Environmental', esg_e_title: 'Environmental Sustainability',
    esg_e_desc: 'Hsin-Chan Industrial builds energy-saving and low-carbon principles into product design and service processes, helping customers reduce process energy consumption, chemical usage, and material waste at the source.',
    esg_e_p1: 'High-concentration nano-bubble fluid module: physical nano-bubbles replace chemical additives, achieving cleaning and sterilization assistance with zero chemical additives, lowering chemical procurement and wastewater treatment costs',
    esg_e_p2: 'Digital Twin and equipment intelligence upgrade services: real-time IoT monitoring extends the life of existing equipment, reducing unplanned downtime by up to 30% and lowering equipment replacement frequency and resource consumption',
    esg_e_p3: 'Refractory materials and industrial heaters: improve insulation efficiency in furnaces and heating systems, reducing energy loss',
    esg_e_p4: 'Machine vision (AOI): automated defect detection reduces defective-product escape rates, cutting material scrap and rework waste',
    esg_e_btn: 'Enquire About Eco-Friendly Process Solutions',
    esg_s_num: 'ESG · S', esg_s_tag: 'Social', esg_s_title: 'Social Inclusion',
    esg_s_desc: 'From production-line safety to cross-border service, Hsin-Chan Industrial uses automation to reduce workplace risk, while local manufacturing and multilingual service support supply chain resilience and talent development.',
    esg_s_p1: 'Robotic arm integration and fixture/jig design: replacing high-risk, highly repetitive manual work to reduce occupational injury risk',
    esg_s_p2: 'Custom service commitment of 1-2 business day response: helping SME customers maintain stable production schedules',
    esg_s_p3: 'Traditional Chinese, Japanese, and English service: enabling seamless cross-border supply chain communication with customers in Japan and Southeast Asia',
    esg_s_p4: 'Local manufacturing and talent development in Taoyuan: supporting local employment, rooted in Taiwan\'s manufacturing cluster for 30 years',
    esg_s_btn: 'View Careers & Openings',
    esg_g_num: 'ESG · G', esg_g_tag: 'Governance', esg_g_title: 'Integrity & Governance',
    esg_g_desc: 'Centered on the Toyota Production System (TPS) and Kazuo Inamori\'s philosophy of "respecting heaven and loving people," Hsin-Chan Industrial builds quality traceability and transparent communication into every order.',
    esg_g_p1: 'Every batch is tested for dimensions, temperature resistance, and strength before shipment, with a complete inspection report provided',
    esg_g_p2: 'Genchi Genbutsu principle: engineers visit the customer site in person to confirm requirements, avoiding spec misinterpretation',
    esg_g_p3: 'Custom specifications are documented and managed to support customer supply-chain audits and traceability requirements',
    esg_g_p4: 'Kaizen continuous improvement culture: standardized operating procedures (SOP) and poka-yoke mechanisms reduce quality risk',
    esg_g_btn: 'Contact Us About Partnership Terms',
    esg_faq1_q: 'How do Hsin-Chan Industrial\'s products help customers meet their ESG goals?',
    esg_faq1_a: 'Hsin-Chan Industrial builds ESG practices into its products and services: on the environmental side, a chemical-free nano-bubble fluid module and energy-saving equipment intelligence services; on the social side, automation such as robotic arm integration and fixture design to reduce workplace risk, plus multilingual cross-border service; on the governance side, pre-shipment quality inspection and the Genchi Genbutsu principle to ensure supply chain transparency and traceability.',
    esg_faq2_q: 'How does the high-concentration nano-bubble fluid module benefit the environment?',
    esg_faq2_a: 'Traditional cleaning processes rely on chemical additives. Hsin-Chan Industrial\'s nano-bubble fluid module uses physical micro-impact force instead of chemicals to achieve cleaning and sterilization assistance, significantly reducing chemical procurement and wastewater treatment costs while lessening the environmental impact of chemical waste.',
    esg_faq3_q: 'How do Digital Twin and equipment intelligence services reduce resource waste?',
    esg_faq3_a: 'Real-time IoT monitoring of equipment status enables predictive maintenance that reduces unplanned downtime by up to 30% and extends the life of existing equipment, lowering resource consumption from equipment replacement. Production lines can gain digital and energy-efficiency improvements without a full equipment overhaul.',
    esg_faq4_q: 'How does Hsin-Chan Industrial ensure supply chain governance and quality traceability?',
    esg_faq4_a: 'Every batch is tested for dimensions, temperature resistance, and strength before shipment, with a complete inspection report provided. We also uphold the Genchi Genbutsu principle — engineers visit customer sites in person to confirm actual requirements and site constraints, ensuring specification documents match actual deliverables and meeting customer supply-chain audit requirements.',
    esg_eyebrow_cta: 'PARTNER WITH US',
    esg_cta_title: 'Want to know how Hsin-Chan Industrial can support your company\'s ESG reporting?',
    esg_cta_desc: 'Whether it\'s process decarbonization, supply chain governance, or sustainable procurement needs, reach out to Hsin-Chan Industrial\'s technical team — we\'ll help you find the right product and service solution.',
    esg_cta_btn: 'Contact Us Now',
