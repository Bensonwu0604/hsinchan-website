...
const translations = {
  zh: {
    ...
    pp_p1_app: '壓鑄機 / 射出成型', pp_p1_mat: 'SKD61 工具鋼', pp_p1_vtag: 'Integral Tube',
    ...
    pp_p5_type: 'SiC棒 / MoSi₂ / 鉑金絲', pp_p5_heat: '至 1800°C', pp_p5_spec: '依客戶需求客製', pp_p5_vtag: 'Heater',
    ...
    srv_page_lead: '欣晨工業有限公司六大自動化服務，從數位規劃、機械手臂整合、視覺檢測，到設備智能化升級，一站式滿足您的製造需求。',
  ...
  ja: {
    ...
    pp_p1_app: 'ダイカスト機 / 射出成形', pp_p1_mat: 'SKD61 工具鋼', pp_p1_vtag: '一体型バレル',
    ...
    pp_p5_type: 'SiC棒 / MoSi₂ / 白金線', pp_p5_heat: '最大1800°C', pp_p5_spec: 'お客様のご要望に応じてカスタマイズ', pp_p5_vtag: 'ヒーター',
    ...
    srv_page_lead: '欣晨工業有限公司の6つの自動化サービス。デジタル計画からロボットアーム統合・画像検査・設備インテリジェント化まで、製造ニーズをワンストップで満たします。',
  ...
  en: {
    ...
    pp_p1_app: 'Die Casting / Injection Molding', pp_p1_mat: 'SKD61 Tool Steel', pp_p1_vtag: 'Integral Tube',
    ...
    pp_p5_type: 'SiC Rod / MoSi₂ / Platinum Wire', pp_p5_heat: 'Up to 1800°C', pp_p5_spec: 'Customized to customer requirements', pp_p5_vtag: 'Heater',
    ...
    srv_page_lead: 'Hsin-Chan Industrial Co., Ltd. offers six automation services covering digital planning, robotic arm integration, machine vision inspection, and equipment intelligence upgrades — one-stop manufacturing solutions.',
